...
if st.session_state.get("authentication_status") == True:
    ...
    if uploaded_file is not None:
        ...
        # FIX 6: interpolación linear como método más estable; cubic como opción avanzada
        try:
